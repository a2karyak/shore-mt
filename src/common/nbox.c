...
/*
 *  $Id: nbox.c,v 1.12 1996/04/22 17:22:08 jiebing Exp $
 */
#define SM_SOURCE
#define NBOX_C
#ifdef __GNUC__
...
//
static int rotation_table[4] = { 3, 0, 0, 1};
static int sense_table[4] = {-1, 1, 1, -1};
static int quad_table[4][2][2] = { {{0,1}, {3,2}}, {{1,2}, {0,3}},
		{{2,3}, {1,0}}, {{3,0}, {2,1}} };
