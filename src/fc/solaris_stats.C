...
ostream& operator<<( ostream& o, const unix_stats &s) 
{
	...
	o << "seconds/iter: ";
	o << form("  clk: %6d",(int)(c/s.iterations)) << " ";
	o << form("  usr: %6d",(int)(u/s.iterations)) << " ";
	o << form("  sys: %6d",(int)(sys/s.iterations)) << " ";
	o << endl;

	o << form("minfaults %6d", s.page_reclaims()) << endl;
	o << form("majfaults %6d", s.page_faults()) << endl;
	o << form("swaps     %6d", s.swaps()) << endl;
	o << form("csw       %6d", s.vcsw()) << endl;
	o << form("inv       %6d", s.invcsw()) << endl;
	o << form("inbloc    %6d", s.inblock()) << endl;
	o << form("outblock  %6d", s.oublock()) << endl;
	o << form("iochars   %6d", s.iochars()) << endl;
	o << form("syscalls  %6d", s.syscalls()) << endl;
	o << form("ssignals  %6d", s.signals()) << endl;
	o << form("msgsnd    %6d", s.msgsent()) << endl;
	o << form("msgrcv    %6d", s.msgrecv()) << endl;
	return o;
}
