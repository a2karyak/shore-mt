...
#define SMT_lid_lookups              0x00070000,65
#define SMT_lid_remote_lookups              0x00070000,66
#define SMT_lid_inserts              0x00070000,67
#define SMT_lid_removes              0x00070000,68
#define SMT_lid_cache_hits              0x00070000,69
#define SMT_page_fix_cnt              0x00070000,70
#define SMT_page_refix_cnt              0x00070000,71
#define SMT_page_unfix_cnt              0x00070000,72
#define SMT_page_alloc_cnt              0x00070000,73
#define SMT_page_dealloc_cnt              0x00070000,74
#define SMT_ext_lookup_hits              0x00070000,75
#define SMT_ext_lookup_misses              0x00070000,76
#define SMT_alloc_page_in_ext              0x00070000,77
#define SMT_extent_lsearch              0x00070000,78
#define SMT_extent_lsearch_hop              0x00070000,79
#define SMT_begin_xct_cnt              0x00070000,80
#define SMT_commit_xct_cnt              0x00070000,81
#define SMT_abort_xct_cnt              0x00070000,82
#define SMT_prepare_xct_cnt              0x00070000,83
#define SMT_rollback_savept_cnt              0x00070000,84
#define SMT_mpl_attach_cnt              0x00070000,85
#define SMT_anchors              0x00070000,86
#define SMT_compensate_in_log              0x00070000,87
#define SMT_compensate_in_xct              0x00070000,88
#define SMT_compensate_records              0x00070000,89
#define SMT_compensate_skipped              0x00070000,90
#define SMT_log_switches              0x00070000,91
#define SMT_await_1thread_log              0x00070000,92
#define SMT_acquire_1thread_log              0x00070000,93
#define SMT_get_logbuf              0x00070000,94
#define SMT_await_1thread_xct              0x00070000,95
#define SMT_await_io_monitor              0x00070000,96
#define SMT_await_vol_monitor              0x00070000,97
#define SMT_s_prepared              0x00070000,98
#define SMT_c_replies_dropped              0x00070000,99
#define SMT_lock_query_cnt              0x00070000,100
#define SMT_unlock_request_cnt              0x00070000,101
#define SMT_lock_request_cnt              0x00070000,102
#define SMT_lock_head_t_cnt              0x00070000,103
#define SMT_lock_acquire_cnt              0x00070000,104
#define SMT_lk_vol_acq              0x00070000,105
#define SMT_lk_store_acq              0x00070000,106
#define SMT_lk_page_acq              0x00070000,107
#define SMT_lk_kvl_acq              0x00070000,108
#define SMT_lk_rec_acq              0x00070000,109
#define SMT_lk_ext_acq              0x00070000,110
#define SMT_lk_user1_acq              0x00070000,111
#define SMT_lk_user2_acq              0x00070000,112
#define SMT_lk_user3_acq              0x00070000,113
#define SMT_lk_user4_acq              0x00070000,114
#define SMT_lock_cache_hit_cnt              0x00070000,115
#define SMT_lock_request_t_cnt              0x00070000,116
#define SMT_lock_extraneous_req_cnt              0x00070000,117
#define SMT_lock_conversion_cnt              0x00070000,118
#define SMT_lock_deadlock_cnt              0x00070000,119
#define SMT_lock_esc_to_page              0x00070000,120
#define SMT_lock_esc_to_store              0x00070000,121
#define SMT_lock_esc_to_volume              0x00070000,122
#define SMT_await_log_monitor              0x00070000,123
#define SMT_await_log_monitor_var              0x00070000,124
#define SMT_xlog_records_generated              0x00070000,125
#define SMT_xlog_bytes_generated              0x00070000,126
#define SMT_STATMIN             0x70000
#define SMT_STATMAX             0x7007e
