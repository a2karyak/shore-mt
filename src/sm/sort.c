...
/*
 *  $Id: sort.c,v 1.70 1996/05/28 23:10:38 jiebing Exp $
 */
...
#endif
static int
_char_cmp(uint4 klen1, const void* kval1, uint4 klen2, const void* kval2)
#undef klen1
#undef klen2
{
...
#endif
static int
_char_rcmp(uint4 klen1, const void* kval1, uint4 klen2, const void* kval2)
#undef klen1
#undef klen2
{
    w_assert3(klen1 == klen2);
...
#endif
static int
_int_cmp(uint4 klen1, const void* kval1, uint4 klen2, const void* kval2)
#undef klen1
#undef klen2
{
    w_assert3(klen1 == klen2);
    return (* (int*) kval1) - (* (int*) kval2);
}
...
#define klen2 /* klen2 not used */
#endif
_int_rcmp(uint4 klen1, const void* kval1, uint4 klen2, const void* kval2)
#undef klen1
#undef klen2
{
    w_assert3(klen1 == klen2);
    return (* (int*) kval2) - (* (int*) kval1);
}
...
#endif
static int
_float_cmp(uint4 klen1, const void* kval1, uint4 klen2, const void* kval2)
#undef klen1
#undef klen2
{
    w_assert3(klen1 == klen2);
    float tmp = (* (float*) kval1) - (* (float*) kval2);
...
#endif
static int
_float_rcmp(uint4 klen1, const void* kval1, uint4 klen2, const void* kval2)
#undef klen1
#undef klen2
{
    w_assert3(klen1 == klen2);
    float tmp = (* (float*) kval2) - (* (float*) kval1);
    return tmp < 0 ? -1 : ((tmp > 0) ? 1 : 0);
}
...
//
static int 
_string_cmp(uint4 klen1, const void* kval1, uint4 klen2, const void* kval2)
{
...
static int 
_string_rcmp(uint4 klen1, const void* kval1, uint4 klen2, const void* kval2)
{
...
//
static PFC 
get_cmp_func(key_info_t::key_type_t type, bool up)
{
    if (up) {
      switch(type) {
      	case key_info_t::t_char:	return _char_cmp;
      	case key_info_t::t_float:	return _float_cmp;
      	case key_info_t::t_string:return _string_cmp;
      	case key_info_t::t_spatial:return _spatial_cmp;
      	case key_info_t::t_int:
      	default: 			return _int_cmp;
      }
    } else {
      switch(type) {
      	case key_info_t::t_char:	return _char_rcmp;
      	case key_info_t::t_float:	return _float_rcmp;
      	case key_info_t::t_string:return _string_rcmp;
      	case key_info_t::t_spatial:return _spatial_rcmp;
      	case key_info_t::t_int:
      	default: 			return _int_rcmp;
      }
    }
}
...
operator>(run_scan_t& s1, run_scan_t& s2)
{
    ...
    int len1, len2;
    if (s1.kinfo.len==0 && s1.kinfo.type==key_info_t::t_string) {
...
static void QuickSort(char* a[], int cnt, int (*compar)(void*, void*) )
{
		...
		const lvid_t& logical_vid)
{
    ...
    bool fast_spatial = (kinfo.type==key_info_t::t_spatial && !sp.unique);
    if (fast_spatial) { 
	// hack to speed up spatial comparison:
	// use hilbert value (turn into an integer sort)
	kinfo.type = key_info_t::t_int;
