...
/*
 *  $Id: chkpt.c,v 1.52 1996/05/03 04:07:26 kupsch Exp $
 */
 ...
 *
 *********************************************************************/
smutex_t                      chkpt_m::_chkpt_mutex("_xct_chkpt");

void
chkpt_m::chkpt_mutex_release()
{
