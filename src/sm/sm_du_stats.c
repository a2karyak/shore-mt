...
/*
 *  $Id: sm_du_stats.c,v 1.14 1995/09/15 03:44:12 zwilling Exp $
 */
...
void file_pg_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void lgdata_pg_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void lgindex_pg_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
{
    return o << s.file_pg << s.lgdata_pg << s.lgindex_pg
...
void file_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void btree_lf_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void btree_int_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void btree_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void rtree_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void volume_hdr_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void volume_map_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void small_store_stats_t::print(ostream& o) const
{
    o << "du stats not implemented" << endl;
}
...
void sm_du_stats_t::print(ostream& o) const
{
    o << "du stats PRETTY PRINT not implemented" << endl;
    o << *this;
#ifdef JUNK
    o <<"\nUnallocated filep pages           : " << u.fi.p_unused_sm
      <<"\nUnallocated lg pages              : " << u.fi.p_unused_lg
      <<"\nAllocated pages                   : " << u.fi.p_used
      <<"\n-- large index pages              : " << u.fi.p_large_index
      <<"\n-- large data pages               : " << u.fi.p_large
      <<"\n------ lg data bytes                   : " << u.fi.b_lg_user_data
      <<"\n------ unused bytes                    : " << u.fi.b_lg_unused
      <<"\n------ overhead(hdr)                   : " << u.fi.b_lg_hdr
      <<"\n-- small rec pages                : " << u.fi.p_small
      <<"\n------ user hdr + body bytes           : " << u.fi.b_sm_user_data
      <<"\n------ unused bytes                    : " << u.fi.b_sm_unused
      <<"\n------ lost in alignment               : " << u.fi.b_align
      <<"\n------ pg hdr + slot array             : " << u.fi.b_slothdr
      <<"\n------ record hdrs                     : " << u.fi.b_rectag;

    o <<"\nIndex pages          : " << u.bt.num_index_pages
      <<"\nLeaf pages           : " << u.bt.num_leaf_pages
      <<"\nUnused pages         : " << u.bt.num_unused_pages
      <<"\nLevels               : " << u.bt.num_levels
      <<"\nUnique Entries       : " << u.bt.num_unique_entries
      <<"\nEntries              : " << u.bt.num_entries
      <<"\nEntry data           : " << u.bt.entry_data
      <<"\nEntry overhead       : " << u.bt.entry_overhead;
    o << endl << flush;
#endif
}
